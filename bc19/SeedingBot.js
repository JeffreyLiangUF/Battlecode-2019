        ...
        Castle.prototype.Execute = function () {
            ...
            if (this.initialized) {
                ...
                if (this.robot.me.turn === 30) {
                    this.robot.signal(65535, this.robot.map.length * this.robot.map.length);
                }
                if (bc19.Helper.EnemiesAround(this.robot)) {
                ...
                if (this.robot.karbonite > 50 && this.robot.me.turn >= 350 && bc19.Helper.CanAfford(this.robot, this.seigeSpawnOrder[this.positionInSeigeOrder])) {
